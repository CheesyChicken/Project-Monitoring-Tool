...
// router.get('/done/:gi', requireAuth, (req, res, next) => {
...
router.get('/done/:gi', requireAuth, (req, res, next) => {
    var gi = req.params.gi;
    var sql = "Select * from project_task where Group_id=? AND Approved_Date is NOT NULL and Status != 'Deleted'"
...
router.post('/done', requireAuth, (req, res, next) => {
