      ...
      <v-app-bar class="" app style="background-color: #348cd4">
        ...
        <v-app-bar-title class="text-uppercase white--text  pl-0">
          ...
          <v-img
            ...
            height="30"
          />
          <h4 class="font-weight-light mr-2 d-none d-md-inline" v-if="this.currentUser.college === 1">|</h4>
          <h6 class="mt-1 font-weight-light d-none d-md-inline" v-if="this.currentUser.college === 1">Vishwakarma Institute of Information Technology</h6>
          <h6 class="mt-1 font-weight-light d-none d-md-inline" v-else-if="this.currentUser.college === 2">| Vishwakarma Institute of Technology</h6>
          <h5 class="mt-1 font-weight-light d-none d-md-inline" v-else-if="this.currentUser.college === 3">| Vishwakarma University</h5>
          </div>
        </v-app-bar-title>
        <v-spacer></v-spacer>

        <!-- <router-link to="/hod/profile" class="nav-link">
        ...
        <v-menu bottom offset-y class="elevation-0">
          ...
          <v-card class="text-center pt-4 elevation-0" style="min-width: 300px">
            ...
            <!-- <v-divider></v-divider> -->
            <v-btn block tile class="pa-5 blue lighten-5" to="/hod/profile"
        ...
        <v-list>
          ...
          <v-list-item-group>
            <router-link
              :to="{
                name: 'HOD allTask',
                params: { stat: '4', depa: this.currentUser.department },
              }"
              style="text-decoration: none; color: inherit"
            >
              <v-list-item>
          ...
          <v-list-item-group>
            ...
            >
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title class="white--text">FTR</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </router-link>
          </v-list-item-group>
          ...
          <v-list-item-group>
            ...
            >
              <v-list-item>
                <v-list-item-action>
                  <v-icon class="white--text">mdi-account-box-multiple</v-icon>
                </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title class="white--text"
                    >All Students</v-list-item-title
