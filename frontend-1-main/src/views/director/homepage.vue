<template>
  <div id="app">
    ...
    <div id="box">
      <v-card>
        <div class="container">
          <h1 class="text-center display-1 mb-10" v-if="this.currentUser.college == 1">Vishwakarma Institute of Information Technology</h1>
          <h1 class="text-center display-1 mb-10" v-else-if="this.currentUser.college == 2">Vishwakarma Institute of Technology</h1>
          <h1 class="text-center display-1 mb-10" v-else-if="this.currentUser.college == 3">Vishwakarma University</h1>
          <div class="row">
            <div class="col-12">
              <div class="row mb-3">
...
export default {
  ...
  methods: {
    getdata() {
      this.$http.get(`/api/homedir/${this.currentUser.college}`).then(
        (result) => {
    ...
    gettable() {
      this.$http.get(`/api/hometabledir/${this.currentUser.college}`).then(
        (result) => {
          console.log(result.data);
