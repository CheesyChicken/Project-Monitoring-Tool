<template>
  <div id="app">
    ...
    <div id="box">
      <b-card style="background-color:#f2f2f2">
        <h3 class="">
          Following groups have not filled the "About project" form
        </h3>
        <div class="row">
          <div
          ...
          <div class="ml-3 mt-5">
            <p>
              <strong>Please Note:</strong> Project Monitoring for a faculty can
              only be started after all the projects assigned to that faculty
              have filled up the <strong>"About Project"</strong> form.
              <br />The details of groups along with contact details of the
